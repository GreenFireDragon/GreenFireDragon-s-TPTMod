...
"\blGreenFireDragon's TPTMod - Version " MTOS(MOD_VERSION) "." MTOS(MOD_MINOR) " - http://powdertoy.co.uk/Discussions/Thread/View.html?Thread=18691 \n"
...
#endif
	"\n"
	"\btMod Version " MTOS(MOD_VERSION) "." MTOS(MOD_MINOR) "." MTOS(MOD_BUILD) "\n"
	"\btTPT Version " MTOS(SAVE_VERSION) "." MTOS(MINOR_VERSION) "." MTOS(BUILD_NUM) "\n"
	"\bt" IDENT_PLATFORM " "
#ifdef X86
	"X86 "
#endif
