...
std::vector<Element> GetElements()
{
	...
	elements.push_back(Element_BPOW());
	elements.push_back(Element_ALPD());
	elements.push_back(Element_IRNX());
	elements.push_back(Element_FFGE());
	elements.push_back(Element_FOFI());
	elements.push_back(Element_FSPW());
	elements.push_back(Element_STKP());
	elements.push_back(Element_SLCN());
	elements.push_back(Element_BSLN());
	elements.push_back(Element_CPER());
	elements.push_back(Element_SND());
	elements.push_back(Element_SWAV());
	elements.push_back(Element_PING());
	elements.push_back(Element_PONG());
	elements.push_back(Element_AMPL());
	elements.push_back(Element_VOMB());
	elements.push_back(Element_CTRL());
	elements.push_back(Element_SOIL());
	elements.push_back(Element_MUD());
	elements.push_back(Element_TSED());
	elements.push_back(Element_FSED());
	elements.push_back(Element_FLWR());
	elements.push_back(Element_RBTY());
	elements.push_back(Element_NEMR());
	elements.push_back(Element_RAND());
	return elements;
}
