...
#define PT_GRVT 177
#define PT_DRAY 178
#define PT_BPOW PT_NORMAL_NUM + 1
#define PT_CPER PT_NORMAL_NUM + 10
#define PT_SND PT_NORMAL_NUM + 11
#define PT_SWAV PT_NORMAL_NUM + 12
#define PT_PING PT_NORMAL_NUM + 13
#define PT_PONG PT_NORMAL_NUM + 14
#define PT_AMPL PT_NORMAL_NUM + 15
#define PT_VOMB PT_NORMAL_NUM + 16
#define PT_CTRL PT_NORMAL_NUM + 17
#define PT_SOIL PT_NORMAL_NUM + 18
#define PT_MUD PT_NORMAL_NUM + 19
#define PT_ALPD PT_NORMAL_NUM + 2
#define PT_TSED PT_NORMAL_NUM + 20
#define PT_FSED PT_NORMAL_NUM + 21
#define PT_FLWR PT_NORMAL_NUM + 22
#define PT_IRNX PT_NORMAL_NUM + 3
#define PT_FFGE PT_NORMAL_NUM + 4
#define PT_FOFI PT_NORMAL_NUM + 5
#define PT_FSPW PT_NORMAL_NUM + 6
#define PT_STKP PT_NORMAL_NUM + 7
#define PT_SLCN PT_NORMAL_NUM + 8
#define PT_BSLN PT_NORMAL_NUM + 9
#define PT_RBTY PT_NORMAL_NUM + 23
#define PT_NEMR PT_NORMAL_NUM + 24
#define PT_RAND PT_NORMAL_NUM + 25
...
class Element_BPOW: public Element
{
public:
	Element_BPOW();
	virtual ~Element_BPOW();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_CPER: public Element
{
public:
	Element_CPER();
	virtual ~Element_CPER();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_SND: public Element
{
public:
	Element_SND();
	virtual ~Element_SND();
...
class Element_SWAV: public Element
{
public:
	Element_SWAV();
	virtual ~Element_SWAV();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_PING: public Element
{
public:
	Element_PING();
	virtual ~Element_PING();
	static int RuleTable[5][16];
	static int ping[XRES/16][YRES/5];;
	static int update(UPDATE_FUNC_ARGS);
};

class Element_PONG: public Element
{
public:
	Element_PONG();
	virtual ~Element_PONG();
	static int RuleTable[5][16];
	static int pong[XRES/16][YRES/5];;
	static int update(UPDATE_FUNC_ARGS);
};

class Element_AMPL: public Element
{
public:
	Element_AMPL();
	virtual ~Element_AMPL();
	
};

class Element_VOMB: public Element
{
public:
	Element_VOMB();
	virtual ~Element_VOMB();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_CTRL: public Element
{
public:
	Element_CTRL();
	virtual ~Element_CTRL();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_SOIL: public Element
{
public:
	Element_SOIL();
	virtual ~Element_SOIL();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_MUD: public Element
{
public:
	Element_MUD();
	virtual ~Element_MUD();
...
class Element_ALPD: public Element
{
public:
	Element_ALPD();
	virtual ~Element_ALPD();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_TSED: public Element
{
public:
	Element_TSED();
	virtual ~Element_TSED();
	static int update(UPDATE_FUNC_ARGS);
	static int TreeGen(UPDATE_FUNC_ARGS);
};

class Element_FSED: public Element
{
public:
	Element_FSED();
	virtual ~Element_FSED();
	static int update(UPDATE_FUNC_ARGS);
	static int FlowerGen(int type, UPDATE_FUNC_ARGS);
	static int Type1Table[6][5];
	static int Type2Table[11][11];
};

class Element_FLWR: public Element
{
public:
	Element_FLWR();
	virtual ~Element_FLWR();
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_IRNX: public Element
{
public:
	Element_IRNX();
	virtual ~Element_IRNX();
	
};

class Element_FFGE: public Element
{
public:
	Element_FFGE();
	virtual ~Element_FFGE();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_FOFI: public Element
{
public:
	Element_FOFI();
	virtual ~Element_FOFI();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_FSPW: public Element
{
public:
	Element_FSPW();
	virtual ~Element_FSPW();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_STKP: public Element
{
public:
	Element_STKP();
	virtual ~Element_STKP();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_SLCN: public Element
{
public:
	Element_SLCN();
	virtual ~Element_SLCN();
	
};

class Element_BSLN: public Element
{
public:
	Element_BSLN();
	virtual ~Element_BSLN();
...
class Element_NEMR : public Element
{
public:
	Element_NEMR();
	virtual ~Element_NEMR();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_RAND : public Element
{
public:
	Element_RAND();
	virtual ~Element_RAND();
	static int update(UPDATE_FUNC_ARGS);
};
