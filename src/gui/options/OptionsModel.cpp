...
void OptionsModel::SetMaxSaveID(std::string i)
{
	Client::Ref().SetPref("MaxSaveID", i);
	notifySettingsChanged();
}
std::string OptionsModel::GetMaxSaveID()
{
	return Client::Ref().GetPrefString("MaxSaveID", "1500000");
}
